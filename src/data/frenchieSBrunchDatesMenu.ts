export const frenchieSBrunchDatesMenu = [
  { name: "Frenchie S Brunch Dates Special Starters 1", price: "RM 12.90", category: "Starters", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Frenchie S Brunch Dates Special Main Course 1", price: "RM 12.90", category: "Main Course", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Frenchie S Brunch Dates Special Specials 1", price: "RM 12.90", category: "Specials", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Frenchie S Brunch Dates Special Desserts 1", price: "RM 12.90", category: "Desserts", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Frenchie S Brunch Dates Special Sides 1", price: "RM 12.90", category: "Sides", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Frenchie S Brunch Dates Special Beverages 1", price: "RM 12.90", category: "Beverages", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Frenchie S Brunch Dates Special Chef's Recommendations 1", price: "RM 12.90", category: "Chef's Recommendations", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
