export const bidadariTurunMalamCafeMenu = [
  { name: "Bidadari Turun Malam Cafe Special Starters 1", price: "RM 12.90", category: "Starters", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Bidadari Turun Malam Cafe Special Main Course 1", price: "RM 12.90", category: "Main Course", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Bidadari Turun Malam Cafe Special Specials 1", price: "RM 12.90", category: "Specials", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Bidadari Turun Malam Cafe Special Desserts 1", price: "RM 12.90", category: "Desserts", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Bidadari Turun Malam Cafe Special Sides 1", price: "RM 12.90", category: "Sides", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Bidadari Turun Malam Cafe Special Beverages 1", price: "RM 12.90", category: "Beverages", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
  ...
  { name: "Bidadari Turun Malam Cafe Special Chef's Recommendations 1", price: "RM 12.90", category: "Chef's Recommendations", description: "A must-try item from our special menu. Prepared uniquely for our guests." },
