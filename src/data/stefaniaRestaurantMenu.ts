export const stefaniaRestaurantMenu = [
  {
    category: "Antipasti (Starters)",
    name: "Alici Marinate",
    price: "RM 45",
    description: "Classic Roman marinated white anchovies served with roasted capsicum and vibrant salsa verde."
  },
  {
    category: "Antipasti (Starters)",
    name: "Alici Fritte",
    price: "RM 42",
    description: "Crispy fried sardines, a staple of authentic Italian coastal dining."
  },
  {
    category: "Antipasti (Starters)",
    name: "Polipo in Umido",
    price: "RM 95",
    description: "Tender, slow-stewed octopus in a rich tomato and herb sauce."
  },
  {
